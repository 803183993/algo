package com.ace.algorithms.suffixtree;
...
public class SuffixTree
{
    ...
    {
        System.out.printf("Searching for pattern %s%n", pattern);
    ...
    {
        System.out.printf(">>>>>>>>>>>> Adding new suffix {}%s%n", suffix);
    ...
    private List<Node> getAllNodesInTraversePath(String pattern, Node startNode, boolean isAllowPartialMatch)
    {
        ...
        for (
                int i = 0; i < startNode.getChildren()
                .size(); i++
        )
        {
